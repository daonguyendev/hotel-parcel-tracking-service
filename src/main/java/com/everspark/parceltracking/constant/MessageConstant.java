...
public class MessageConstant {
    ...
    public static final String PARCEL_ALREADY_PICKED_UP = "This parcel has already been picked up.";
    public static final String ALL_PARCEL_ALREADY_PICKED_UP = "All parcel has already been picked up.";
